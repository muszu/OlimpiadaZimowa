...
CREATE TABLE skoki_narciarskie ( 
	id_zawodnika         integer  NOT NULL,
	id_rozgrywki         integer  NOT NULL,
	odleglosc            numeric(4,1)  NOT NULL,
	sedzia1              numeric(3,1)  NOT NULL,
	sedzia2              numeric(3,1)  NOT NULL,
	sedzia3              numeric(3,1)  NOT NULL,
	sedzia4              numeric(3,1)  NOT NULL,
	sedzia5              numeric(3,1)  NOT NULL,
